# Linux SCSI数据盘扩容后处理（fdisk）<a name="ZH-CN_TOPIC_0170873795"></a>
...
3.  <a name="l4e31601beaec4a7aa80e5edf0f77638e"></a>刷新完成后，执行以下命令，再次查看云硬盘分区信息。
...
## 设置开机自动挂载磁盘<a name="s2fa3e1e62f4f48d89fbe13b75df1b7ae"></a>
